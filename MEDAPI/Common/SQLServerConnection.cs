...
namespace CMS_Core.Common
{
    ...
    {
        public List<AnyType> SelectQueryCommand1(string connectionSQL, string spName, params object[] values)
        {
        ...
        /// <returns></returns>
        public List<AnyType> SelectQueryCommand2(string connectionSQL, string spName, params object[] values)
        {
            ///Thực hiện stored (values là danh sách các biến theo thứ tự) trả về bảng
            if (string.IsNullOrEmpty(spName))
                throw new ArgumentException("Không đưa tên stored");
        ...
        public List<AnyType> SelectQuery1(string command,string connectionSQL)
        {
            ///Thực hiện stored (values là danh sách các biến theo thứ tự) trả về bảng
        ...
        public List<AnyType> SelectQuery2(string command, string connectionSQL)
        {
            ///Thực hiện stored (values là danh sách các biến theo thứ tự) trả về bảng
            if (string.IsNullOrEmpty(command))
                throw new ArgumentException("Không đưa câu lệnh vào");
        ...
        /// <param name="connectionSQL"></param>
        /// <returns></returns>
        public bool insertSQL(string command, string connectionSQL)
        {
            ///Thực hiện stored (values là danh sách các biến theo thứ tự) trả về bảng
            if (string.IsNullOrEmpty(command))
                throw new ArgumentException("Không đưa câu lệnh vào");
        ...
        /// <param name="values"></param>
        /// <returns></returns>
        public string ExecuteInsert(string connectionSQL, string spName, params object[] values)
        {
        ...
        /// <param name="values"></param>
        /// <returns></returns>
        public string ExecuteInsertWithConn(string spName, string conn, params object[] values)
        {
            ///Thực hiện store, values là các biến đưa vào stored theo thứ tự           
            if (string.IsNullOrEmpty(spName))
                throw new ArgumentException("Không đưa tên stored");
            ...
            if (dataPARAMETERS == null)
            {
                ...
                {
                    ImpINFORMATION_SCHEMA_PARAMETERS impINFORMATION_SCHEMA_PARAMETERS = new ImpINFORMATION_SCHEMA_PARAMETERS();
                    dataPARAMETERS = impINFORMATION_SCHEMA_PARAMETERS.GetINFORMATION_SCHEMA_PARAMETERSByProcedure(spName, conn);
                    HttpContext.Current.Session["INFORMATION_SCHEMA_PARAMETERS" + spName] = dataPARAMETERS;
        ...
        /// <param name="values"></param>
        /// <returns></returns>
        public string ExecuteInsertEncrypt(string connectionSQL, string spName, string listColumn, params object[] values)
        {
            ///Thực hiện store, values là các biến đưa vào stored theo thứ tự           
            if (string.IsNullOrEmpty(spName))
                throw new ArgumentException("Không đưa tên stored");
        ...
        /// <param name="values"></param>
        /// <returns></returns>
        public string ExecuteUpdateEncrypt(string connectionSQL, string spName, string listColumn, params object[] values)
        {
            ///Thực hiện store, values là các biến đưa vào stored theo thứ tự           
            if (string.IsNullOrEmpty(spName))
                throw new ArgumentException("Không đưa tên stored");
        ...
        /// <param name="values"></param>
        /// <returns></returns>
        public string ExecuteNonQuery(string connectionSQL, string spName, params object[] values)
        {
            ///Thực hiện store, values là các biến đưa vào stored theo thứ tự           
            if (string.IsNullOrEmpty(spName))
                throw new ArgumentException("Không đưa tên stored");
        ...
        /// <param name="values"></param>
        /// <returns></returns>
        public object ExecuteScalar(string connectionSQL, string spName, params object[] values)
        {
